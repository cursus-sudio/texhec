...
func (Pkg) LoadConfig(b ioc.Builder) {
	ioc.WrapService(b, scenes.LoadConfig, func(c ioc.Dic, b gamescenes.CreditsBuilder) gamescenes.CreditsBuilder {
...
func (pkg Pkg) Loadsystems(b ioc.Builder) {
	ioc.WrapService(b, scenes.LoadSystems, func(c ioc.Dic, b gamescenes.CreditsBuilder) gamescenes.CreditsBuilder {
		b.OnLoad(func(ctx scenes.SceneCtx) {
			logger := ioc.Get[logger.Logger](c)
...
func (Pkg) LoadInitialEvents(b ioc.Builder) {
	ioc.WrapService(b, scenes.LoadInitialEvents, func(c ioc.Dic, b gamescenes.CreditsBuilder) gamescenes.CreditsBuilder {
		b.OnLoad(func(ctx scenes.SceneCtx) {
