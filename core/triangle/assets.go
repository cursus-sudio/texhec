...
func registerAssets(b ioc.Builder) {
	ioc.WrapService(b, ioc.DefaultOrder, func(c ioc.Dic, b assets.AssetsStorageBuilder) assets.AssetsStorageBuilder {
		b.RegisterAsset(HalfMeshAssetID, func() (assets.StorageAsset, error) {
			vertices := []vbo.Vertex{
				// Front face
				{Pos: [3]float32{0, 0, 0}, TexturePos: [2]float32{0, 0}},
				{Pos: [3]float32{0, -1, 0}, TexturePos: [2]float32{1, 0}},
				{Pos: [3]float32{-1, -1, 0}, TexturePos: [2]float32{1, 1}},
				{Pos: [3]float32{-1, 0, 0}, TexturePos: [2]float32{0, 1}},

				// Back face
				{Pos: [3]float32{-1, 0, -1}, TexturePos: [2]float32{1, 0}},
				{Pos: [3]float32{-1, -1, -1}, TexturePos: [2]float32{1, 1}},
				{Pos: [3]float32{0, -1, -1}, TexturePos: [2]float32{0, 1}},
				{Pos: [3]float32{0, 0, -1}, TexturePos: [2]float32{0, 0}},
			}
