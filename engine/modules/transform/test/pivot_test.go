...
func TestPivot(t *testing.T) {
	...
	setup.Transform.PivotPoint().SaveComponent(entity, transform.NewPivotPoint(0, 0, 0))
	setup.expectAbsolutePos(entity, transform.NewPos(5, 5, 5))

	setup.Transform.PivotPoint().SaveComponent(entity, transform.NewPivotPoint(1, 1, 1))
	setup.expectAbsolutePos(entity, transform.NewPos(-5, -5, -5))
}
