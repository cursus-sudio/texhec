This module is a nightmare to work with.
This module desperatly needs a refactor.

TODO before:
- extend ecs querying capabilities to overwrite track if component is already required
